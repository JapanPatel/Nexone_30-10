...
const ServiceDetails = () => {
  ...
  return (
    <Layout>
      <Breadcumb2
        pageName={"Cloud-Based Application Development "}
        crumbs={crumbs}
        selected={selected}
      />
      {/*==================================================*/}
                  ...
                  <div className="col-lg-12 col-sm-12">
                    <div className="consen-service-details-box">
                      <div className="consen-service-thumb">
                        <img
                          src="assets/images/resource/orags/custom-application-development.png"
                ...
                <div className="row">
                  <div className="col-lg-12 col-sm-12">
                    <div className="consen-service-details-box">
                      <div className="consen-service-thumb">
                        <img
                          src="assets/images/resource/orags/cloud-application.svg"
                  ...
                  <div className="col-lg-5 col-md-6">
                    <div className="service-details-thumb">
                      <img
                        src="assets/images/resource/orags/key-features-cloud-application.png"
                        alt="Key Features cloud Application"
                      />
                    </div>
                  </div>
                  <div className="col-lg-7 col-md-6">
