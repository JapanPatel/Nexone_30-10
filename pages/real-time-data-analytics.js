  ...
  return (
    <Layout>
      <Breadcumb2
        ...
        selected={selected}
      />
      {/* <Breadcumb1 pageName={"Real-time Data Analytics"} title={"Real-time Data Analytics"} /> */}
      {/*==================================================*/}
                ...
                <div className="row">
                  <div className="col-lg-12 col-sm-12">
                    <div className="consen-service-details-box">
                      <div className="consen-service-thumb">
                        <img
                          src="assets/images/resource/orags/real-time-data-service.svg"
                          alt="Real Time Data Service"
                        />
                      </div>
                      <div className="service-details-content">
                        <div className="service-page-title">
