                  ...
                  <div className="col-lg-12 col-sm-12">
                    <div className="consen-service-details-box">
                      <div className="consen-service-thumb">
                        <img
                          src="assets/images/resource/orags/web-app-development.png"
                ...
                <div className="row">
                  <div className="col-lg-12 col-sm-12">
                    <div className="consen-service-details-box">
                      <div className="consen-service-thumb">
                        <img
                          src="assets/images/resource/orags/web-app-development.svg"
                          alt="Web Application Development"
                        />
                      </div>
                      <div className="service-details-content">
                  ...
                  <div className="col-lg-5 col-md-6">
                    <div className="service-details-thumb">
                      <img
                        src="assets/images/resource/orags/key-features-web-app.png"
                        alt="Key Features Web App"
                      />
                    </div>
                  </div>
                  <div className="col-lg-7 col-md-6">
